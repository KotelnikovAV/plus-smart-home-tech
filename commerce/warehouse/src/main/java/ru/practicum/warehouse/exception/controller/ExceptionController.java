package ru.practicum.warehouse.exception.controller;
...
import ru.practicum.warehouse.exception.DataDuplicationException;
import ru.practicum.warehouse.exception.NoProductsInShoppingCartException;
...
import ru.practicum.warehouse.exception.model.ApiError;
...
public class ExceptionController {
    ...
    public ApiError handleNoSpecifiedProductInWarehouseException(NoSpecifiedProductInWarehouseException e) {
        ...
        return ApiError.builder()
                ...
                .localizedMessage(e.getLocalizedMessage())
                .suppressed(e.getSuppressed())
                .userMessage("All items were not found during the return")
                .message(e.getMessage())
                .build();
    }
}
